  ...
  const makeVideoString = (name) => {
    const videoId = "video-js";
    const VIDEO_STRING = `<video id="${videoId}" class="video-js" controls preload="metadata" width="640" height="264" data-setup="{}">` +
    `<source src="/data/${name}.m3u8" type="application/x-mpegURL">` +
    `</video>`;
    return VIDEO_STRING;
