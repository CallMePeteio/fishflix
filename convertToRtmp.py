...
def tcp_to_rtmp(tcp_url, rtmp_url, rtmp_key, log, fps=30):
    """
...
tcp_to_rtmp(streamSettings["tcpUrl"], streamSettings["rtmpUrl"], streamSettings["rtmpKey"], streamSettings["log-ffmpeg"], streamSettings["fps"]) # STARTS STREAMING TO THE SERVER
